# USAGE:
# ruby abundant_peps_with_ratio.rb ../data/WT1_F001775_with_pipes.csv ../data/PIA1_F001771_with_pipes.csv 0.05 20.0 ../results/WT1_PIA1_analysis.xlsx

# ruby abundant_peps_with_ratio.rb ../data/WT2_F001788_with_pipes.csv ../data/PIA2_F001773_with_pipes.csv 0.05 20.0 ../results/WT2_PIA2_analysis.xlsx

# ruby abundant_peps_with_ratio.rb ../data/WT3_F001777_with_pipes.csv ../data/PIA3_F001772_with_pipes.csv 0.05 20.0 ../results/WT3_PIA3_analysis.xlsx

# ruby abundant_peps_with_ratio.rb ../data/WT_F001778_with_pipes.csv ../data/PIA_F001774_with_pipes.csv 0.05 20.0 ../results/WT_PIA_analysis.xlsx
...
results_wb.add_worksheet(:name => "WT-PIA differential expression") do |sheet|
	sheet.add_row ["PROT_ACC", "UNIPROT_LINK", "PROT_DESC", "WT PROT_HIT_NUM", "PIA PROT_HIT_NUM", "WT PROT_SCORE", "PIA PROT_SCORE", "WT PROT_MATCH_SIG", "PIA PROT_MATCH_SIG", "PROT_MATCH_SIG PIA:WT", "LOG(PROT_MATCH_SIG PIA:WT)", "WT PROT_MATCH", "PIA PROT_MATCH", "PROT_MATCH PIA:WT", "LOG(PROT_MATCH PIA:WT)"], :style=>header
	...
	common_proteins.each do |protein, hits|
		...
		if pia_prot_matches != 0.0 && wt_prot_matches != 0.0 # there is no need for this check
			...
			norm_pia_prot_matches = pia_prot_matches/total_pia_prot_matches
			norm_wt_prot_matches = wt_prot_matches/total_wt_prot_matches
			ratio_total = (norm_pia_prot_matches/norm_wt_prot_matches).to_f
			logratio_total = Math::log(ratio_total)
		else
			logratio_total = ""
		end

		row = sheet.add_row [protein, uniprot_link, prot_desc, wt_prot_hit_num, pia_prot_hit_num, wt_prot_score, pia_prot_score, wt_prot_matches_sig, pia_prot_matches_sig, pia_prot_matches_sig.to_s+":"+wt_prot_matches_sig.to_s, logratio_sig, wt_prot_matches, pia_prot_matches, pia_prot_matches.to_s+":"+wt_prot_matches.to_s, logratio_total], :style=>alignment
